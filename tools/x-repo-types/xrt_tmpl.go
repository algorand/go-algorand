...
import (
	...
	xpkg "github.com/algorand/go-algorand/data/bookkeeping"  // 	/* GENERATOR ONLY */
...
// Main is not main for compilation purposes. (see `make template4xrt` for why it's still Main)
func Main() { // replaced by main() in `make template4xrt`
	...
	x := reflect.TypeOf(xpkg.Genesis{}) //					    	/* GENERATOR ONLY */
	// y := reflect.TypeOf(ypkg.Genesis{}) //						/* GENERATOR ONLY */
