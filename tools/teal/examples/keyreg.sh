...
python driver.py delegate-key-registration --fee 100000 --dur 95 --period 100 --auth QY5UZGE746YGIEQ66UPPWO4Z55SJEZLZJDEXSN6RAHXWYIDTO4KA5RHZUQ --x uFVDhjBpkpKQ8sZaau0qsDsf0eW3oXFEn1Ar5o39vkk= > delegate.teal
