...
const (
	stateproofTrackingLoc StateProofTrackingLocation = iota
	trackerDB
	trackerMemory
)
...
func TestStateProofVerificationTracker_StateProofsDisabled(t *testing.T) {
	...
	verifyStateProofVerificationTracking(t, spt, defaultFirstStateProofContextRound, uint64(roundsAmount)/defaultStateProofInterval, defaultStateProofInterval, false, stateproofTrackingLoc)
}
...
func TestStateProofVerificationTracker_StateProofsNotStuck(t *testing.T) {
	...
	verifyStateProofVerificationTracking(t, spt, defaultFirstStateProofContextRound, expectedRemainingContextNum, defaultStateProofInterval, false, stateproofTrackingLoc)
	...
	verifyStateProofVerificationTracking(t, spt, finalLastAttestedRound, 1, defaultStateProofInterval, true, stateproofTrackingLoc)
}
...
func TestStateProofVerificationTracker_CommitFullDbPruning(t *testing.T) {
	...
	verifyStateProofVerificationTracking(t, spt, defaultFirstStateProofContextRound, maxStateProofsToGenerate, defaultStateProofInterval, false, stateproofTrackingLoc)
...
func TestStateProofVerificationTracker_CommitPartialDbPruning(t *testing.T) {
	...
	verifyStateProofVerificationTracking(t, spt, defaultFirstStateProofContextRound, contextToRemove, defaultStateProofInterval, false, stateproofTrackingLoc)
...
func TestStateProofVerificationTracker_StateProofIntervalChange(t *testing.T) {
	...
	verifyStateProofVerificationTracking(t, spt, firstNewIntervalLastAttestedRound, newIntervalContext,
		newStateProofInterval, true, stateproofTrackingLoc)
	...
	verifyStateProofVerificationTracking(t, spt, defaultFirstStateProofContextRound, oldIntervalContext, defaultStateProofInterval,
		false, stateproofTrackingLoc)
	verifyStateProofVerificationTracking(t, spt, firstNewIntervalLastAttestedRound,
		newIntervalRemovedStateProofs, newStateProofInterval, false, stateproofTrackingLoc)
