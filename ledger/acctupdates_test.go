...
func BenchmarkCompactDeltas(b *testing.B) {
	b.Run("account-deltas", func(b *testing.B) {
		...
		makeCompactAccountDeltas(accountDeltas, 0, baseAccounts)
...
func TestCompactDeltas(t *testing.T) {
	...
	var baseAccounts lruAccounts
	baseAccounts.init(nil, 100, 80)
	outAccountDeltas := makeCompactAccountDeltas(accountDeltas, basics.Round(1), baseAccounts)
...
func TestCompactDeltasResources(t *testing.T) {
	...
	outResourcesDeltas := makeCompactResourceDeltas(accountDeltas, basics.Round(1), baseAccounts, baseResources)
