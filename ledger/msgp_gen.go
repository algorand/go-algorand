...
func (_ *catchpointDataInfo) CanMarshalMsg(z interface{}) bool {
	_, ok := (z).(*catchpointDataInfo)
	return ok
}

// UnmarshalMsg implements msgp.Unmarshaler
func (z *catchpointDataInfo) UnmarshalMsg(bts []byte) (o []byte, err error) {
	var field []byte
	_ = field
	var zb0001 int
	var zb0002 bool
...
func (_ *catchpointDataInfo) CanUnmarshalMsg(z interface{}) bool {
	_, ok := (z).(*catchpointDataInfo)
	return ok
}
