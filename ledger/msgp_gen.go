	...
	if _, ok := err.(msgp.TypeError); ok {
		...
		if zb0002 > 0 {
			...
			if zb0005 {
				...
				(*z).Balances = make([]accountdb.EncodedBalanceRecordV5, zb0004)
			}
			for zb0001 := range (*z).Balances {
		...
		for zb0002 > 0 {
			...
			case "bl":
				...
				if zb0007 {
					...
					(*z).Balances = make([]accountdb.EncodedBalanceRecordV5, zb0006)
				}
				for zb0001 := range (*z).Balances {
					bts, err = (*z).Balances[zb0001].UnmarshalMsg(bts)
					if err != nil {
	...
	if _, ok := err.(msgp.TypeError); ok {
		...
		if zb0002 > 0 {
			...
			if zb0005 {
				...
				(*z).Balances = make([]accountdb.EncodedBalanceRecordV6, zb0004)
			}
			for zb0001 := range (*z).Balances {
				bts, err = (*z).Balances[zb0001].UnmarshalMsg(bts)
				if err != nil {
		...
		for zb0002 > 0 {
			...
			case "bl":
				...
				if zb0007 {
					...
					(*z).Balances = make([]accountdb.EncodedBalanceRecordV6, zb0006)
				}
				for zb0001 := range (*z).Balances {
					bts, err = (*z).Balances[zb0001].UnmarshalMsg(bts)
					if err != nil {
