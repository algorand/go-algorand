						...
						TxnGroups: []simulation.TxnGroupResult{
							{
								Txns: []simulation.TxnResult{
									{},
									{
										...
										AppBudgetUsed:      AppBudgetConsumed,
										LogicSigBudgetUsed: testCase.cost,
									},
								},
					...
					TxnGroups: []simulation.TxnGroupResult{
						{
							...
							Txns: []simulation.TxnResult{
								{
									AppBudgetUsed: scenario.AppBudgetUsed[0],
								},
								{
									Txn: transactions.SignedTxnWithAD{
										ApplyData: scenario.ExpectedSimulationAD,
									},
									AppBudgetUsed: scenario.AppBudgetUsed[1],
								},
							},
						},
					},
