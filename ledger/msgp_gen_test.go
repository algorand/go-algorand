...
func TestMarshalUnmarshalonlineAccount(t *testing.T) {
	v := onlineAccount{}
	bts, err := v.MarshalMsg(nil)
	if err != nil {
		t.Fatal(err)
...
func TestRandomizedEncodingonlineAccount(t *testing.T) {
	protocol.RunEncodingTest(t, &onlineAccount{})
}

func BenchmarkMarshalMsgonlineAccount(b *testing.B) {
	v := onlineAccount{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgonlineAccount(b *testing.B) {
	v := onlineAccount{}
	bts := make([]byte, 0, v.Msgsize())
	bts, _ = v.MarshalMsg(bts[0:0])
	b.SetBytes(int64(len(bts)))
...
func BenchmarkUnmarshalonlineAccount(b *testing.B) {
	v := onlineAccount{}
	bts, _ := v.MarshalMsg(nil)
	b.ReportAllocs()
	b.SetBytes(int64(len(bts)))
