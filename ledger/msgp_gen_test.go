...
func TestMarshalUnmarshalcatchpointDataInfo(t *testing.T) {
	partitiontest.PartitionTest(t)
	v := catchpointDataInfo{}
	bts := v.MarshalMsg(nil)
	left, err := v.UnmarshalMsg(bts)
	if err != nil {
		t.Fatal(err)
...
func TestRandomizedEncodingcatchpointDataInfo(t *testing.T) {
	protocol.RunEncodingTest(t, &catchpointDataInfo{})
}

func BenchmarkMarshalMsgcatchpointDataInfo(b *testing.B) {
	v := catchpointDataInfo{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgcatchpointDataInfo(b *testing.B) {
	v := catchpointDataInfo{}
	bts := make([]byte, 0, v.Msgsize())
	bts = v.MarshalMsg(bts[0:0])
	b.SetBytes(int64(len(bts)))
...
func BenchmarkUnmarshalcatchpointDataInfo(b *testing.B) {
	v := catchpointDataInfo{}
	bts := v.MarshalMsg(nil)
	b.ReportAllocs()
	b.SetBytes(int64(len(bts)))
...
func TestMarshalUnmarshalcatchpointInfo(t *testing.T) {
	partitiontest.PartitionTest(t)
	v := catchpointInfo{}
	bts := v.MarshalMsg(nil)
	left, err := v.UnmarshalMsg(bts)
...
func TestRandomizedEncodingcatchpointInfo(t *testing.T) {
	protocol.RunEncodingTest(t, &catchpointInfo{})
}

func BenchmarkMarshalMsgcatchpointInfo(b *testing.B) {
	v := catchpointInfo{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgcatchpointInfo(b *testing.B) {
	v := catchpointInfo{}
	bts := make([]byte, 0, v.Msgsize())
	bts = v.MarshalMsg(bts[0:0])
	b.SetBytes(int64(len(bts)))
...
func BenchmarkUnmarshalcatchpointInfo(b *testing.B) {
	v := catchpointInfo{}
	bts := v.MarshalMsg(nil)
	b.ReportAllocs()
	b.SetBytes(int64(len(bts)))
