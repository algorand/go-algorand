...
func (z *ApplicationCallTxnFields) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	if _, ok := err.(msgp.TypeError); ok {
		...
		if zb0004 > 0 {
			...
			if zb0007 > 256 {
				err = msgp.ErrOverflow(uint64(zb0007), uint64(256))
				err = msgp.WrapError(err, "struct-from-array", "ApplicationArgs")
				return
			}
			if zb0008 {
		...
		if zb0004 > 0 {
			...
			if zb0009 > 256 {
				err = msgp.ErrOverflow(uint64(zb0009), uint64(256))
				err = msgp.WrapError(err, "struct-from-array", "Accounts")
				return
			}
			if zb0010 {
		...
		if zb0004 > 0 {
			...
			if zb0011 > 256 {
				err = msgp.ErrOverflow(uint64(zb0011), uint64(256))
				err = msgp.WrapError(err, "struct-from-array", "ForeignApps")
				return
			}
			if zb0012 {
		...
		for zb0004 > 0 {
			...
			case "apan":
				{
					...
					(*z).OnCompletion = OnCompletion(zb0013)
				}
			case "apaa":
				var zb0014 int
				var zb0015 bool
				...
				if zb0014 > 256 {
					err = msgp.ErrOverflow(uint64(zb0014), uint64(256))
					err = msgp.WrapError(err, "ApplicationArgs")
					return
				}
				if zb0015 {
					(*z).ApplicationArgs = nil
				} else if (*z).ApplicationArgs != nil && cap((*z).ApplicationArgs) >= zb0014 {
					(*z).ApplicationArgs = ((*z).ApplicationArgs)[:zb0014]
				} else {
					(*z).ApplicationArgs = make([][]byte, zb0014)
				}
				for zb0001 := range (*z).ApplicationArgs {
					(*z).ApplicationArgs[zb0001], bts, err = msgp.ReadBytesBytes(bts, (*z).ApplicationArgs[zb0001])
					if err != nil {
			...
			case "apat":
				...
				if zb0016 > 256 {
					err = msgp.ErrOverflow(uint64(zb0016), uint64(256))
					err = msgp.WrapError(err, "Accounts")
					return
				}
				if zb0017 {
					(*z).Accounts = nil
				} else if (*z).Accounts != nil && cap((*z).Accounts) >= zb0016 {
					(*z).Accounts = ((*z).Accounts)[:zb0016]
				} else {
					(*z).Accounts = make([]basics.Address, zb0016)
				}
				for zb0002 := range (*z).Accounts {
					bts, err = (*z).Accounts[zb0002].UnmarshalMsg(bts)
					if err != nil {
			...
			case "apfa":
				...
				if zb0018 > 256 {
					err = msgp.ErrOverflow(uint64(zb0018), uint64(256))
					err = msgp.WrapError(err, "ForeignApps")
					return
				}
				if zb0019 {
					(*z).ForeignApps = nil
				} else if (*z).ForeignApps != nil && cap((*z).ForeignApps) >= zb0018 {
					(*z).ForeignApps = ((*z).ForeignApps)[:zb0018]
				} else {
					(*z).ForeignApps = make([]basics.AppIndex, zb0018)
				}
				for zb0003 := range (*z).ForeignApps {
					bts, err = (*z).ForeignApps[zb0003].UnmarshalMsg(bts)
					if err != nil {
	...
	if _, ok := err.(msgp.TypeError); ok {
		...
		if zb0005 > 0 {
			zb0005--
			{
				...
				(*z).ApplicationCallTxnFields.OnCompletion = OnCompletion(zb0007)
			}
		}
		if zb0005 > 0 {
			zb0005--
			...
			if zb0008 > 256 {
				err = msgp.ErrOverflow(uint64(zb0008), uint64(256))
				err = msgp.WrapError(err, "struct-from-array", "ApplicationArgs")
				return
			}
			if zb0009 {
				(*z).ApplicationCallTxnFields.ApplicationArgs = nil
			} else if (*z).ApplicationCallTxnFields.ApplicationArgs != nil && cap((*z).ApplicationCallTxnFields.ApplicationArgs) >= zb0008 {
				(*z).ApplicationCallTxnFields.ApplicationArgs = ((*z).ApplicationCallTxnFields.ApplicationArgs)[:zb0008]
			} else {
				(*z).ApplicationCallTxnFields.ApplicationArgs = make([][]byte, zb0008)
			}
			for zb0002 := range (*z).ApplicationCallTxnFields.ApplicationArgs {
		...
		if zb0005 > 0 {
			...
			if zb0010 > 256 {
				err = msgp.ErrOverflow(uint64(zb0010), uint64(256))
				err = msgp.WrapError(err, "struct-from-array", "Accounts")
				return
			}
			if zb0011 {
				(*z).ApplicationCallTxnFields.Accounts = nil
			} else if (*z).ApplicationCallTxnFields.Accounts != nil && cap((*z).ApplicationCallTxnFields.Accounts) >= zb0010 {
				(*z).ApplicationCallTxnFields.Accounts = ((*z).ApplicationCallTxnFields.Accounts)[:zb0010]
			} else {
				(*z).ApplicationCallTxnFields.Accounts = make([]basics.Address, zb0010)
			}
			for zb0003 := range (*z).ApplicationCallTxnFields.Accounts {
		...
		if zb0005 > 0 {
			...
			if zb0012 > 256 {
				err = msgp.ErrOverflow(uint64(zb0012), uint64(256))
				err = msgp.WrapError(err, "struct-from-array", "ForeignApps")
				return
			}
			if zb0013 {
				(*z).ApplicationCallTxnFields.ForeignApps = nil
			} else if (*z).ApplicationCallTxnFields.ForeignApps != nil && cap((*z).ApplicationCallTxnFields.ForeignApps) >= zb0012 {
				(*z).ApplicationCallTxnFields.ForeignApps = ((*z).ApplicationCallTxnFields.ForeignApps)[:zb0012]
			} else {
				(*z).ApplicationCallTxnFields.ForeignApps = make([]basics.AppIndex, zb0012)
			}
			for zb0004 := range (*z).ApplicationCallTxnFields.ForeignApps {
		...
		for zb0005 > 0 {
			...
			case "apaa":
				...
				if zb0015 > 256 {
					err = msgp.ErrOverflow(uint64(zb0015), uint64(256))
					err = msgp.WrapError(err, "ApplicationArgs")
					return
				}
				if zb0016 {
			...
			case "apat":
				...
				if zb0017 > 256 {
					err = msgp.ErrOverflow(uint64(zb0017), uint64(256))
					err = msgp.WrapError(err, "Accounts")
					return
				}
				if zb0018 {
			...
			case "apfa":
				...
				if zb0019 > 256 {
					err = msgp.ErrOverflow(uint64(zb0019), uint64(256))
					err = msgp.WrapError(err, "ForeignApps")
					return
				}
				if zb0020 {
