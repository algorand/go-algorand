...
func (z *Header) MarshalMsg(b []byte) (o []byte) {
	...
	if (*z).MaxLogicSigArgsTotalSize == 0 {
		zb0002Len--
		zb0002Mask |= 0x40
	}
	...
	if zb0002Len != 0 {
		...
		if (zb0002Mask & 0x40) == 0 { // if not empty
			// string "lsigam"
			o = append(o, 0xa6, 0x6c, 0x73, 0x69, 0x67, 0x61, 0x6d)
			o = msgp.AppendUint64(o, (*z).MaxLogicSigArgsTotalSize)
		}
...
func (z *Header) UnmarshalMsgWithState(bts []byte, st msgp.UnmarshalState) (o []byte, err error) {
	...
	if _, ok := err.(msgp.TypeError); ok {
		...
		if zb0002 > 0 {
			zb0002--
			(*z).MaxLogicSigArgsTotalSize, bts, err = msgp.ReadUint64Bytes(bts)
			if err != nil {
				err = msgp.WrapError(err, "struct-from-array", "MaxLogicSigArgsTotalSize")
				return
			}
		}
		if zb0002 > 0 {
		...
		for zb0002 > 0 {
			...
			case "lsigam":
				(*z).MaxLogicSigArgsTotalSize, bts, err = msgp.ReadUint64Bytes(bts)
				if err != nil {
					err = msgp.WrapError(err, "MaxLogicSigArgsTotalSize")
					return
				}
			default:
				err = msgp.ErrNoField(string(field))
...
func (z *Header) Msgsize() (s int) {
	s = 1 + 4 + (*z).Sender.Msgsize() + 4 + (*z).Fee.Msgsize() + 3 + (*z).FirstValid.Msgsize() + 3 + (*z).LastValid.Msgsize() + 5 + msgp.BytesPrefixSize + len((*z).Note) + 4 + msgp.StringPrefixSize + len((*z).GenesisID) + 3 + (*z).GenesisHash.Msgsize() + 4 + (*z).Group.Msgsize() + 3 + msgp.ArrayHeaderSize + (32 * (msgp.ByteSize)) + 6 + (*z).RekeyTo.Msgsize() + 7 + msgp.Uint64Size
	return
}

// MsgIsZero returns whether this is a zero value
func (z *Header) MsgIsZero() bool {
	return ((*z).Sender.MsgIsZero()) && ((*z).Fee.MsgIsZero()) && ((*z).FirstValid.MsgIsZero()) && ((*z).LastValid.MsgIsZero()) && (len((*z).Note) == 0) && ((*z).GenesisID == "") && ((*z).GenesisHash.MsgIsZero()) && ((*z).Group.MsgIsZero()) && ((*z).Lease == ([32]byte{})) && ((*z).RekeyTo.MsgIsZero()) && ((*z).MaxLogicSigArgsTotalSize == 0)
}
...
func HeaderMaxSize() (s int) {
	...
	s += 6 + basics.AddressMaxSize() + 7 + msgp.Uint64Size
	return
}
...
func (z *Transaction) MarshalMsg(b []byte) (o []byte) {
	...
	if (*z).Header.MaxLogicSigArgsTotalSize == 0 {
		zb0008Len--
	...
	if zb0008Len != 0 {
		...
		if (zb0008Mask & 0x10000000000) == 0 { // if not empty
			// string "lsigam"
			o = append(o, 0xa6, 0x6c, 0x73, 0x69, 0x67, 0x61, 0x6d)
			o = msgp.AppendUint64(o, (*z).Header.MaxLogicSigArgsTotalSize)
		}
...
func (z *Transaction) UnmarshalMsgWithState(bts []byte, st msgp.UnmarshalState) (o []byte, err error) {
	...
	if _, ok := err.(msgp.TypeError); ok {
		...
		if zb0008 > 0 {
			zb0008--
			(*z).Header.MaxLogicSigArgsTotalSize, bts, err = msgp.ReadUint64Bytes(bts)
			if err != nil {
				err = msgp.WrapError(err, "struct-from-array", "MaxLogicSigArgsTotalSize")
				return
			}
