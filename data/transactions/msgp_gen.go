...
// MarshalMsg implements msgp.Marshaler
func (z *DevMode) MarshalMsg(b []byte) (o []byte) {
	o = msgp.Require(b, z.Msgsize())
	// omitempty: check for empty values
	zb0001Len := uint32(2)
	var zb0001Mask uint8 /* 3 bits */
	if (*z).SetNextBlockTime == 0 {
		zb0001Len--
		zb0001Mask |= 0x2
	}
	if (*z).SkipValidation == false {
		zb0001Len--
		zb0001Mask |= 0x4
	}
	// variable map header, size zb0001Len
	...
	if zb0001Len != 0 {
		if (zb0001Mask & 0x2) == 0 { // if not empty
			// string "set_next_block_time"
			o = append(o, 0xb3, 0x73, 0x65, 0x74, 0x5f, 0x6e, 0x65, 0x78, 0x74, 0x5f, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x5f, 0x74, 0x69, 0x6d, 0x65)
			o = msgp.AppendInt64(o, (*z).SetNextBlockTime)
		}
		if (zb0001Mask & 0x4) == 0 { // if not empty
			// string "skip_validation"
			o = append(o, 0xaf, 0x73, 0x6b, 0x69, 0x70, 0x5f, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x69, 0x6f, 0x6e)
			o = msgp.AppendBool(o, (*z).SkipValidation)
		}
	}
	return
}

func (_ *DevMode) CanMarshalMsg(z interface{}) bool {
	_, ok := (z).(*DevMode)
	return ok
}

// UnmarshalMsg implements msgp.Unmarshaler
func (z *DevMode) UnmarshalMsg(bts []byte) (o []byte, err error) {
	var field []byte
	_ = field
	var zb0001 int
	var zb0002 bool
	...
	if _, ok := err.(msgp.TypeError); ok {
		...
		if zb0001 > 0 {
			zb0001--
			(*z).SkipValidation, bts, err = msgp.ReadBoolBytes(bts)
			if err != nil {
				err = msgp.WrapError(err, "struct-from-array", "SkipValidation")
				return
			}
		}
		if zb0001 > 0 {
			zb0001--
			(*z).SetNextBlockTime, bts, err = msgp.ReadInt64Bytes(bts)
			if err != nil {
				err = msgp.WrapError(err, "struct-from-array", "SetNextBlockTime")
				return
			}
		}
		if zb0001 > 0 {
		...
		for zb0001 > 0 {
			...
			case "skip_validation":
				(*z).SkipValidation, bts, err = msgp.ReadBoolBytes(bts)
				if err != nil {
					err = msgp.WrapError(err, "SkipValidation")
					return
				}
			case "set_next_block_time":
				(*z).SetNextBlockTime, bts, err = msgp.ReadInt64Bytes(bts)
				if err != nil {
					err = msgp.WrapError(err, "SetNextBlockTime")
					return
				}
			default:
				err = msgp.ErrNoField(string(field))
...
func (_ *DevMode) CanUnmarshalMsg(z interface{}) bool {
	_, ok := (z).(*DevMode)
	return ok
}

// Msgsize returns an upper bound estimate of the number of bytes occupied by the serialized message
func (z *DevMode) Msgsize() (s int) {
	s = 1 + 16 + msgp.BoolSize + 20 + msgp.Int64Size
	return
}

// MsgIsZero returns whether this is a zero value
func (z *DevMode) MsgIsZero() bool {
	return ((*z).SkipValidation == false) && ((*z).SetNextBlockTime == 0)
}
...
func (z *Transaction) MarshalMsg(b []byte) (o []byte) {
	...
	if ((*z).DevMode.SkipValidation == false) && ((*z).DevMode.SetNextBlockTime == 0) {
		zb0007Len--
	...
	if zb0007Len != 0 {
		...
		if (zb0007Mask & 0x40000000) == 0 { // if not empty
			// string "dev_mode_options"
			o = append(o, 0xb0, 0x64, 0x65, 0x76, 0x5f, 0x6d, 0x6f, 0x64, 0x65, 0x5f, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73)
			// omitempty: check for empty values
			zb0009Len := uint32(2)
			var zb0009Mask uint8 /* 3 bits */
			if (*z).DevMode.SetNextBlockTime == 0 {
				zb0009Len--
				zb0009Mask |= 0x2
			}
			if (*z).DevMode.SkipValidation == false {
				zb0009Len--
				zb0009Mask |= 0x4
			}
			...
			if (zb0009Mask & 0x2) == 0 { // if not empty
				// string "set_next_block_time"
				o = append(o, 0xb3, 0x73, 0x65, 0x74, 0x5f, 0x6e, 0x65, 0x78, 0x74, 0x5f, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x5f, 0x74, 0x69, 0x6d, 0x65)
				o = msgp.AppendInt64(o, (*z).DevMode.SetNextBlockTime)
			}
			if (zb0009Mask & 0x4) == 0 { // if not empty
				// string "skip_validation"
				o = append(o, 0xaf, 0x73, 0x6b, 0x69, 0x70, 0x5f, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x69, 0x6f, 0x6e)
				o = msgp.AppendBool(o, (*z).DevMode.SkipValidation)
			}
		}
	...
	if _, ok := err.(msgp.TypeError); ok {
		...
		if zb0007 > 0 {
			...
			if _, ok := err.(msgp.TypeError); ok {
				...
				if zb0009 > 0 {
					zb0009--
					(*z).DevMode.SkipValidation, bts, err = msgp.ReadBoolBytes(bts)
					if err != nil {
						err = msgp.WrapError(err, "struct-from-array", "DevMode", "struct-from-array", "SkipValidation")
						return
					}
				}
				if zb0009 > 0 {
					zb0009--
					(*z).DevMode.SetNextBlockTime, bts, err = msgp.ReadInt64Bytes(bts)
					if err != nil {
						err = msgp.WrapError(err, "struct-from-array", "DevMode", "struct-from-array", "SetNextBlockTime")
						return
					}
				}
				if zb0009 > 0 {
					...
					if err != nil {
						err = msgp.WrapError(err, "struct-from-array", "DevMode", "struct-from-array")
						return
					}
				}
			} else {
				...
				for zb0009 > 0 {
					...
					case "skip_validation":
						(*z).DevMode.SkipValidation, bts, err = msgp.ReadBoolBytes(bts)
						if err != nil {
							err = msgp.WrapError(err, "struct-from-array", "DevMode", "SkipValidation")
							return
						}
					case "set_next_block_time":
						(*z).DevMode.SetNextBlockTime, bts, err = msgp.ReadInt64Bytes(bts)
						if err != nil {
							err = msgp.WrapError(err, "struct-from-array", "DevMode", "SetNextBlockTime")
							return
						}
					default:
						err = msgp.ErrNoField(string(field))
		...
		if zb0007 > 0 {
			...
			if zb0017 > encodedMaxForeignApps {
				err = msgp.ErrOverflow(uint64(zb0017), uint64(encodedMaxForeignApps))
				err = msgp.WrapError(err, "struct-from-array", "ForeignApps")
				return
			}
			if zb0018 {
				(*z).ApplicationCallTxnFields.ForeignApps = nil
			} else if (*z).ApplicationCallTxnFields.ForeignApps != nil && cap((*z).ApplicationCallTxnFields.ForeignApps) >= zb0017 {
				(*z).ApplicationCallTxnFields.ForeignApps = ((*z).ApplicationCallTxnFields.ForeignApps)[:zb0017]
			} else {
				(*z).ApplicationCallTxnFields.ForeignApps = make([]basics.AppIndex, zb0017)
			}
			for zb0004 := range (*z).ApplicationCallTxnFields.ForeignApps {
		...
		if zb0007 > 0 {
			...
			if zb0019 > encodedMaxBoxes {
				err = msgp.ErrOverflow(uint64(zb0019), uint64(encodedMaxBoxes))
				err = msgp.WrapError(err, "struct-from-array", "Boxes")
				return
			}
			if zb0020 {
				(*z).ApplicationCallTxnFields.Boxes = nil
			} else if (*z).ApplicationCallTxnFields.Boxes != nil && cap((*z).ApplicationCallTxnFields.Boxes) >= zb0019 {
				(*z).ApplicationCallTxnFields.Boxes = ((*z).ApplicationCallTxnFields.Boxes)[:zb0019]
			} else {
				(*z).ApplicationCallTxnFields.Boxes = make([]BoxRef, zb0019)
			}
			for zb0005 := range (*z).ApplicationCallTxnFields.Boxes {
				var zb0021 int
				var zb0022 bool
		...
		if zb0007 > 0 {
			...
			if zb0023 > encodedMaxForeignAssets {
				err = msgp.ErrOverflow(uint64(zb0023), uint64(encodedMaxForeignAssets))
				err = msgp.WrapError(err, "struct-from-array", "ForeignAssets")
				return
			}
			if zb0024 {
				(*z).ApplicationCallTxnFields.ForeignAssets = nil
			} else if (*z).ApplicationCallTxnFields.ForeignAssets != nil && cap((*z).ApplicationCallTxnFields.ForeignAssets) >= zb0023 {
				(*z).ApplicationCallTxnFields.ForeignAssets = ((*z).ApplicationCallTxnFields.ForeignAssets)[:zb0023]
			} else {
				(*z).ApplicationCallTxnFields.ForeignAssets = make([]basics.AssetIndex, zb0023)
			}
			for zb0006 := range (*z).ApplicationCallTxnFields.ForeignAssets {
		...
		if zb0007 > 0 {
			...
			if zb0025 > config.MaxAvailableAppProgramLen {
				err = msgp.ErrOverflow(uint64(zb0025), uint64(config.MaxAvailableAppProgramLen))
				return
			}
		...
		for zb0007 > 0 {
			...
			case "dev_mode_options":
				...
				if _, ok := err.(msgp.TypeError); ok {
					...
					if zb0027 > 0 {
						...
						(*z).DevMode.SkipValidation, bts, err = msgp.ReadBoolBytes(bts)
						if err != nil {
							err = msgp.WrapError(err, "DevMode", "struct-from-array", "SkipValidation")
							return
						}
					}
					if zb0027 > 0 {
						...
						(*z).DevMode.SetNextBlockTime, bts, err = msgp.ReadInt64Bytes(bts)
						if err != nil {
							err = msgp.WrapError(err, "DevMode", "struct-from-array", "SetNextBlockTime")
							return
						}
					}
					if zb0027 > 0 {
						...
						if err != nil {
							err = msgp.WrapError(err, "DevMode", "struct-from-array")
							return
						}
					}
				} else {
					...
					for zb0027 > 0 {
						...
						case "skip_validation":
							(*z).DevMode.SkipValidation, bts, err = msgp.ReadBoolBytes(bts)
							if err != nil {
								err = msgp.WrapError(err, "DevMode", "SkipValidation")
								return
							}
						case "set_next_block_time":
							(*z).DevMode.SetNextBlockTime, bts, err = msgp.ReadInt64Bytes(bts)
							if err != nil {
								err = msgp.WrapError(err, "DevMode", "SetNextBlockTime")
								return
							}
						default:
							err = msgp.ErrNoField(string(field))
			...
			case "note":
				...
				if zb0029 > config.MaxTxnNoteBytes {
					err = msgp.ErrOverflow(uint64(zb0029), uint64(config.MaxTxnNoteBytes))
					return
				}
				(*z).Header.Note, bts, err = msgp.ReadBytesBytes(bts, (*z).Header.Note)
				if err != nil {
			...
			case "apas":
				...
				if zb0041 > encodedMaxForeignAssets {
					err = msgp.ErrOverflow(uint64(zb0041), uint64(encodedMaxForeignAssets))
					err = msgp.WrapError(err, "ForeignAssets")
					return
				}
				if zb0042 {
					(*z).ApplicationCallTxnFields.ForeignAssets = nil
				} else if (*z).ApplicationCallTxnFields.ForeignAssets != nil && cap((*z).ApplicationCallTxnFields.ForeignAssets) >= zb0041 {
					(*z).ApplicationCallTxnFields.ForeignAssets = ((*z).ApplicationCallTxnFields.ForeignAssets)[:zb0041]
				} else {
					(*z).ApplicationCallTxnFields.ForeignAssets = make([]basics.AssetIndex, zb0041)
				}
				for zb0006 := range (*z).ApplicationCallTxnFields.ForeignAssets {
					bts, err = (*z).ApplicationCallTxnFields.ForeignAssets[zb0006].UnmarshalMsg(bts)
					if err != nil {
			...
			case "apap":
				...
				if zb0043 > config.MaxAvailableAppProgramLen {
					err = msgp.ErrOverflow(uint64(zb0043), uint64(config.MaxAvailableAppProgramLen))
					return
				}
				(*z).ApplicationCallTxnFields.ApprovalProgram, bts, err = msgp.ReadBytesBytes(bts, (*z).ApplicationCallTxnFields.ApprovalProgram)
				if err != nil {
			...
			case "apsu":
				...
				if zb0044 > config.MaxAvailableAppProgramLen {
					err = msgp.ErrOverflow(uint64(zb0044), uint64(config.MaxAvailableAppProgramLen))
					return
				}
				(*z).ApplicationCallTxnFields.ClearStateProgram, bts, err = msgp.ReadBytesBytes(bts, (*z).ApplicationCallTxnFields.ClearStateProgram)
				if err != nil {
