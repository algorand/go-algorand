...
func (z *Header) MarshalMsg(b []byte) (o []byte) {
	...
	if zb0002Len != 0 {
		if (zb0002Mask & 0x2) == 0 { // if not empty
			// string "ci"
			o = append(o, 0xa2, 0x63, 0x69)
			o = (*z).CostIncrement.MarshalMsg(o)
		}
...
func (z *Header) UnmarshalMsgWithState(bts []byte, st msgp.UnmarshalState) (o []byte, err error) {
	...
	if _, ok := err.(msgp.TypeError); ok {
		...
		if zb0002 > 0 {
			zb0002--
			bts, err = (*z).CostIncrement.UnmarshalMsgWithState(bts, st)
			if err != nil {
				err = msgp.WrapError(err, "struct-from-array", "CostIncrement")
				return
			}
		}
		if zb0002 > 0 {
		...
		for zb0002 > 0 {
			...
			case "ci":
				bts, err = (*z).CostIncrement.UnmarshalMsgWithState(bts, st)
				if err != nil {
					err = msgp.WrapError(err, "CostIncrement")
					return
				}
			case "fv":
				bts, err = (*z).FirstValid.UnmarshalMsgWithState(bts, st)
...
func (z *Header) Msgsize() (s int) {
	s = 1 + 4 + (*z).Sender.Msgsize() + 4 + (*z).Fee.Msgsize() + 3 + (*z).CostIncrement.Msgsize() + 3 + (*z).FirstValid.Msgsize() + 3 + (*z).LastValid.Msgsize() + 5 + msgp.BytesPrefixSize + len((*z).Note) + 4 + msgp.StringPrefixSize + len((*z).GenesisID) + 3 + (*z).GenesisHash.Msgsize() + 4 + (*z).Group.Msgsize() + 3 + msgp.ArrayHeaderSize + (32 * (msgp.ByteSize)) + 6 + (*z).RekeyTo.Msgsize()
	return
}

// MsgIsZero returns whether this is a zero value
func (z *Header) MsgIsZero() bool {
	return ((*z).Sender.MsgIsZero()) && ((*z).Fee.MsgIsZero()) && ((*z).CostIncrement.MsgIsZero()) && ((*z).FirstValid.MsgIsZero()) && ((*z).LastValid.MsgIsZero()) && (len((*z).Note) == 0) && ((*z).GenesisID == "") && ((*z).GenesisHash.MsgIsZero()) && ((*z).Group.MsgIsZero()) && ((*z).Lease == ([32]byte{})) && ((*z).RekeyTo.MsgIsZero())
}

// MaxSize returns a maximum valid message size for this message type
func HeaderMaxSize() (s int) {
	s = 1 + 4 + basics.AddressMaxSize() + 4 + basics.MicroAlgosMaxSize() + 3 + basics.MicrosMaxSize() + 3 + basics.RoundMaxSize() + 3 + basics.RoundMaxSize() + 5 + msgp.BytesPrefixSize + bounds.MaxTxnNoteBytes + 4 + msgp.StringPrefixSize + bounds.MaxGenesisIDLen + 3 + crypto.DigestMaxSize() + 4 + crypto.DigestMaxSize() + 3
...
func (z *Transaction) MarshalMsg(b []byte) (o []byte) {
	...
	if (*z).Header.CostIncrement.MsgIsZero() {
		zb0008Len--
	...
	if zb0008Len != 0 {
		...
		if (zb0008Mask & 0x80000000) == 0 { // if not empty
			// string "ci"
			o = append(o, 0xa2, 0x63, 0x69)
			o = (*z).Header.CostIncrement.MarshalMsg(o)
		}
...
func (z *Transaction) UnmarshalMsgWithState(bts []byte, st msgp.UnmarshalState) (o []byte, err error) {
	...
	if _, ok := err.(msgp.TypeError); ok {
		...
		if zb0008 > 0 {
			zb0008--
			bts, err = (*z).Header.CostIncrement.UnmarshalMsgWithState(bts, st)
			if err != nil {
				err = msgp.WrapError(err, "struct-from-array", "CostIncrement")
				return
			}
