...
var OpSpecs = []OpSpec{
	...
	{0x05, "ecdsa_verify", opEcdsaVerify, asmEcdsa, disDefault, threeBytes.plus(twoBytes), oneInt, 5, modeAny, costByField("v", &EcdsaCurves, ecdsaVerifyCosts)},
	{0x06, "ecdsa_pk_decompress", opEcdsaPkDecompress, asmEcdsa, disDefault, oneBytes, twoBytes, 5, modeAny, costByField("v", &EcdsaCurves, ecdsaDecompressCosts)},
	{0x07, "ecdsa_pk_recover", opEcdsaPkRecover, asmEcdsa, disDefault, oneBytes.plus(oneInt).plus(twoBytes), twoBytes, 5, modeAny, field("v", &EcdsaCurves).costs(2000)},
	...
	{0x31, "txn", opTxn, asmTxn, disDefault, nil, oneAny, 1, modeAny, field("f", &TxnFields)},
	...
	{0x32, "global", opGlobal, asmGlobal, disDefault, nil, oneAny, 1, modeAny,
		field("f", &GlobalFields)},
	{0x33, "gtxn", opGtxn, asmGtxn, disDefault, nil, oneAny, 1, modeAny,
	...
	{0x36, "txna", opTxna, asmTxna, disDefault, nil, oneAny, 2, modeAny,
		immediates("f", "i").field("f", &TxnaFields)},
	{0x37, "gtxna", opGtxna, asmGtxna, disDefault, nil, oneAny, 2, modeAny,
		immediates("t", "f", "i").field("f", &TxnFields)},
	...
	{0x39, "gtxnsa", opGtxnsa, asmGtxns, disDefault, oneInt, oneAny, 3, modeAny,
		immediates("f", "i").field("f", &TxnFields)},
	...
	{0x5c, "base64_decode", opBase64Decode, asmBase64Decode, disDefault, oneBytes, oneBytes, fidoVersion, modeAny, field("e", &Base64Encodings).costs(25)},
	{0x5d, "json_ref", opJSONRef, asmJSONRef, disDefault, twoBytes, oneAny, fidoVersion, modeAny, field("r", &JsonRefTypes)},
	...
	{0x70, "asset_holding_get", opAssetHoldingGet, asmAssetHolding, disDefault, twoInts, oneAny.plus(oneInt), 2, runModeApplication, field("f", &AssetHoldingFields)},
	{0x70, "asset_holding_get", opAssetHoldingGet, asmAssetHolding, disDefault, oneAny.plus(oneInt), oneAny.plus(oneInt), directRefEnabledVersion, runModeApplication, field("f", &AssetHoldingFields)},
	{0x71, "asset_params_get", opAssetParamsGet, asmAssetParams, disDefault, oneInt, oneAny.plus(oneInt), 2, runModeApplication, field("f", &AssetParamsFields)},
	{0x72, "app_params_get", opAppParamsGet, asmAppParams, disDefault, oneInt, oneAny.plus(oneInt), 5, runModeApplication, field("f", &AppParamsFields)},
	{0x73, "acct_params_get", opAcctParamsGet, asmAcctParams, disDefault, oneAny, oneAny.plus(oneInt), 6, runModeApplication, field("f", &AcctParamsFields)},
	...
	{0xb4, "itxn", opItxn, asmItxn, disDefault, nil, oneAny, 5, runModeApplication,
		field("f", &TxnFields)},
	{0xb5, "itxna", opItxna, asmTxna, disDefault, nil, oneAny, 5, runModeApplication,
		immediates("f", "i").field("f", &TxnFields)},
	...
	{0xb7, "gitxn", opGitxn, asmGitxn, disDefault, nil, oneAny, 6, runModeApplication,
		immediates("t", "f").field("f", &TxnFields)},
	{0xb8, "gitxna", opGitxna, asmGtxna, disDefault, nil, oneAny, 6, runModeApplication,
		immediates("t", "f", "i").field("f", &TxnFields)},

	// Dynamic indexing
	{0xc0, "txnas", opTxnas, asmTxnas, disDefault, oneInt, oneAny, 5, modeAny,
		field("f", &TxnFields)},
	{0xc1, "gtxnas", opGtxnas, asmGtxnas, disDefault, oneInt, oneAny, 5, modeAny,
		immediates("t", "f").field("f", &TxnFields)},
	{0xc2, "gtxnsas", opGtxnsas, asmGtxnsas, disDefault, twoInts, oneAny, 5, modeAny,
		field("f", &TxnFields)},
	...
	{0xc5, "itxnas", opItxnas, asmTxnas, disDefault, oneInt, oneAny, 6, runModeApplication,
		field("f", &TxnFields)},
	{0xc6, "gitxnas", opGitxnas, asmGtxnas, disDefault, oneInt, oneAny, 6, runModeApplication,
		immediates("t", "f").field("f", &TxnFields)},
}
