...
var OpSpecs = []OpSpec{
	...
	{0x60, "balance", opBalance, asmDefault, disDefault, oneInt, oneInt, 2, modeStatefull, opSizeDefault},
	{0x61, "app_opted_in", opAppCheckOptedIn, asmDefault, disDefault, twoInts, oneInt, 2, modeStatefull, opSizeDefault},
	{0x62, "app_read_local", opAppReadLocalState, asmDefault, disDefault, oneBytes.plus(twoInts), oneInt.plus(oneAny), 2, modeStatefull, opSizeDefault},
	{0x63, "app_read_global", opAppReadGlobalState, asmDefault, disDefault, oneBytes, oneInt.plus(oneAny), 2, modeStatefull, opSizeDefault},
