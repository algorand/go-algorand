...
var OpSpecs = []OpSpec{
	...
	*/
	...
	// Byteslice math.
	{0xa0, "b+", opBytesPlus, proto("bb:b", "NN:N"), 4, costly(10)},
	{0xa1, "b-", opBytesMinus, proto("bb:b", "NN:N"), 4, costly(10)},
	{0xa2, "b/", opBytesDiv, proto("bb:b", "NN:N"), 4, costly(20)},
	{0xa3, "b*", opBytesMul, proto("bb:b", "NN:N"), 4, costly(20)},
	{0xa4, "b<", opBytesLt, proto("bb:i", "NN:B"), 4, detDefault()},
	{0xa5, "b>", opBytesGt, proto("bb:i", "NN:B"), 4, detDefault()},
	{0xa6, "b<=", opBytesLe, proto("bb:i", "NN:B"), 4, detDefault()},
