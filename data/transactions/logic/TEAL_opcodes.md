...
- Stack: ... &rarr; ..., any
- txn can be called using txn with 1 immediates. field F of current transaction
...
- Stack: ... &rarr; ..., any
- gtxn can be called using gtxn with 2 immediates. field F of the Tth transaction in the current group
...
- Stack: ... &rarr; ..., any
- txna can be called using txn with 2 immediates. Ith value of the array field F of the current transaction
- Availability: v2
...
- Stack: ... &rarr; ..., any
- gtxna can be called using gtxn with 3 immediates. Ith value of the array field F from the Tth transaction in the current group
- Availability: v2
