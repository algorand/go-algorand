...
const (
	...
	// AppRenter is responsible for extra pages and global state balance requirement.
	AppRenter
...
var appParamsFieldSpecs = [...]appParamsFieldSpec{
	...
	{AppRenter, StackAddress, 13, "If non-zero, this account is responsible for the app's extra pages and global state balance requirement"},
}
