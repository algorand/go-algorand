...
var txnFieldSpecs = []txnFieldSpec{
	...
	{ConfigAsset, StackUint64, 2, 5},
	{ConfigAssetTotal, StackUint64, 2, 5},
	{ConfigAssetDecimals, StackUint64, 2, 5},
	{ConfigAssetDefaultFrozen, StackUint64, 2, 5},
	{ConfigAssetUnitName, StackBytes, 2, 5},
	{ConfigAssetName, StackBytes, 2, 5},
	{ConfigAssetURL, StackBytes, 2, 5},
	{ConfigAssetMetadataHash, StackBytes, 2, 5},
	{ConfigAssetManager, StackBytes, 2, 5},
	{ConfigAssetReserve, StackBytes, 2, 5},
	{ConfigAssetFreeze, StackBytes, 2, 5},
	{ConfigAssetClawback, StackBytes, 2, 5},
	{FreezeAsset, StackUint64, 2, 5},
	{FreezeAssetAccount, StackBytes, 2, 5},
	{FreezeAssetFrozen, StackUint64, 2, 5},
