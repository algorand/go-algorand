// Code generated by "stringer -type=TxnField,GlobalField,AssetParamsField,AppParamsField,AcctParamsField,AssetHoldingField,OnCompletionConstType,EcdsaCurve,EcGroup,MimcConfig,Poseidon2Config,FalconConfig,Base64Encoding,JSONRefType,VoterParamsField,VrfStandard,BlockField -output=fields_string.go"; DO NOT EDIT.
...
func _() {
	...
	_ = x[FalconDet1024-0]
	_ = x[FalconDet512-1]
	_ = x[invalidFalconConfig-2]
}

const _FalconConfig_name = "FalconDet1024FalconDet512invalidFalconConfig"

var _FalconConfig_index = [...]uint8{0, 13, 25, 44}

func (i FalconConfig) String() string {
	idx := int(i) - 0
	if i < 0 || idx >= len(_FalconConfig_index)-1 {
		return "FalconConfig(" + strconv.FormatInt(int64(i), 10) + ")"
	}
	return _FalconConfig_name[_FalconConfig_index[idx]:_FalconConfig_index[idx+1]]
}
func _() {
	// An "invalid array index" compiler error signifies that the constant values have changed.
	// Re-run the stringer command to generate them again.
