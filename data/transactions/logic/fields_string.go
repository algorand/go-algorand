...
func _() {
	...
	_ = x[RekeyTo-32]
	_ = x[invalidTxnField-33]
}

const _TxnField_name = ""

var _TxnField_index = [...]uint16{0, 6, 9, 19, 33, 42, 46, 51, 59, 65, 81, 87, 98, 107, 115, 130, 134, 142, 151, 162, 173, 186, 198, 208, 212, 225, 237, 252, 262, 270, 281, 296, 313, 320, 335}
