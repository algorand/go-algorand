...
var opDocByName = map[string]string{
	...
	"divmodw":           "A divided by B with the reminder. Takes two 128 uints, in the form of two pairs of uint64s on the stack, pushes result and reminder (4 values)",
...
var OpGroupList = []OpGroup{
	{"Arithmetic", []string{"sha256", "keccak256", "sha512_256", "ed25519verify", "+", "-", "/", "*", "<", ">", "<=", ">=", "&&", "||", "==", "!=", "!", "len", "itob", "btoi", "%", "|", "&", "^", "~", "mulw", "addw", "divmodw", "getbit", "setbit", "getbyte", "setbyte", "concat", "substring", "substring3"}},
