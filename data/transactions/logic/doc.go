...
var opDocByName = map[string]string{
	...
	"extractuvarint":      "pop a byte-array A and integer B. Extract a range of bytes from A starting at B up to but not including 0+8, convert bytes as big endian and push the uint64 result and number of bytes read.",
