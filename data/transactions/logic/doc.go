...
var opDocByName = map[string]string{
	...
	"extractUvarint":      "pop a byte-array A. Extract a range of bytes from A starting at 0 up to but not including 0+8, convert bytes as big endian and push the uint64 result and number of bytes read.",
