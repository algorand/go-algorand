...
var opDocExtraList = []stringString{
	...
	{"txn", "FirstValidTime is actually the time of the round before FirstValid which should be about 5 seconds before the FirstValid round. Subtle implementation details make it much faster to serve details of an already completed round."},
