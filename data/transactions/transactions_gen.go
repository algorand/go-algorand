...
func (z *Transaction) MarshalMsg(b []byte) (o []byte, err error) {
	...
	if (zb0002Mask & 0x2000000000) == 0 { // if not empty
		// string "xaid"
		o = append(o, 0xa4, 0x78, 0x61, 0x69, 0x64)
...
func (z *TxGroup) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	for zb0002 > 0 {
		...
		case "txlist":
			...
			if cap((*z).TxGroupHashes) >= int(zb0003) {
...
// MsgIsZero returns whether this is a zero value
func (z TxnPriority) MsgIsZero() bool {
	return z == 0
}
