...
func TestMarshalUnmarshalPaysetDigest(t *testing.T) {
	v := PaysetDigest{}
	bts := v.MarshalMsg(nil)
	left, err := v.UnmarshalMsg(bts)
	if err != nil {
...
func TestRandomizedEncodingPaysetDigest(t *testing.T) {
	protocol.RunEncodingTest(t, &PaysetDigest{})
}

func BenchmarkMarshalMsgPaysetDigest(b *testing.B) {
	v := PaysetDigest{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgPaysetDigest(b *testing.B) {
	v := PaysetDigest{}
	bts := make([]byte, 0, v.Msgsize())
	bts = v.MarshalMsg(bts[0:0])
	b.SetBytes(int64(len(bts)))
...
func BenchmarkUnmarshalPaysetDigest(b *testing.B) {
	v := PaysetDigest{}
	bts := v.MarshalMsg(nil)
	b.ReportAllocs()
	b.SetBytes(int64(len(bts)))
