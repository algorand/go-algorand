...
func TestMarshalUnmarshalboxRefStringly(t *testing.T) {
	partitiontest.PartitionTest(t)
	v := boxRefStringly{}
	bts := v.MarshalMsg(nil)
	left, err := v.UnmarshalMsg(bts)
...
func TestRandomizedEncodingboxRefStringly(t *testing.T) {
	protocol.RunEncodingTest(t, &boxRefStringly{})
}

func BenchmarkMarshalMsgboxRefStringly(b *testing.B) {
	v := boxRefStringly{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgboxRefStringly(b *testing.B) {
	v := boxRefStringly{}
	bts := make([]byte, 0, v.Msgsize())
	bts = v.MarshalMsg(bts[0:0])
	b.SetBytes(int64(len(bts)))
...
func BenchmarkUnmarshalboxRefStringly(b *testing.B) {
	v := boxRefStringly{}
	bts := v.MarshalMsg(nil)
	b.ReportAllocs()
	b.SetBytes(int64(len(bts)))
