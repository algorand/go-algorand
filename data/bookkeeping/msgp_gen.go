...
func (z *Block) MarshalMsg(b []byte) (o []byte) {
	...
	zb0005Len := uint32(35)
	var zb0005Mask uint64 /* 40 bits */
	if (*z).BlockHeader.Bonus.MsgIsZero() {
		zb0005Len--
		zb0005Mask |= 0x20
	}
	if (*z).BlockHeader.CongestionFee.MsgIsZero() {
		zb0005Len--
		zb0005Mask |= 0x40
	}
	...
	if (*z).BlockHeader.Load.MsgIsZero() {
		zb0005Len--
		zb0005Mask |= 0x2000
	}
	...
	if zb0005Len != 0 {
		...
		if (zb0005Mask & 0x40) == 0 { // if not empty
			...
			o = (*z).BlockHeader.CongestionFee.MarshalMsg(o)
		}
		...
		if (zb0005Mask & 0x2000) == 0 { // if not empty
			...
			o = (*z).BlockHeader.Load.MarshalMsg(o)
		}
...
func (z *Block) UnmarshalMsgWithState(bts []byte, st msgp.UnmarshalState) (o []byte, err error) {
	...
	if _, ok := err.(msgp.TypeError); ok {
		...
		if zb0005 > 0 {
			zb0005--
			bts, err = (*z).BlockHeader.CongestionFee.UnmarshalMsgWithState(bts, st)
			if err != nil {
				err = msgp.WrapError(err, "struct-from-array", "CongestionFee")
				return
			}
		}
		if zb0005 > 0 {
		...
		for zb0005 > 0 {
			...
			case "cf":
				bts, err = (*z).BlockHeader.CongestionFee.UnmarshalMsgWithState(bts, st)
				if err != nil {
					err = msgp.WrapError(err, "CongestionFee")
					return
				}
			case "txns":
				bts, err = (*z).Payset.UnmarshalMsgWithState(bts, st)
...
func BlockMaxSize() (s int) {
	...
	s += 3 + basics.MicrosMaxSize() + 3 + basics.MicroAlgosMaxSize() + 5
...
func (z *BlockHeader) MarshalMsg(b []byte) (o []byte) {
	...
	if zb0005Len != 0 {
		...
		if (zb0005Mask & 0x40) == 0 { // if not empty
			// string "cf"
			o = append(o, 0xa2, 0x63, 0x66)
			o = (*z).CongestionFee.MarshalMsg(o)
		}
		if (zb0005Mask & 0x80) == 0 { // if not empty
			// string "earn"
			o = append(o, 0xa4, 0x65, 0x61, 0x72, 0x6e)
...
func (z *BlockHeader) UnmarshalMsgWithState(bts []byte, st msgp.UnmarshalState) (o []byte, err error) {
	...
	if _, ok := err.(msgp.TypeError); ok {
		...
		if zb0005 > 0 {
			zb0005--
			bts, err = (*z).CongestionFee.UnmarshalMsgWithState(bts, st)
			if err != nil {
				err = msgp.WrapError(err, "struct-from-array", "CongestionFee")
				return
			}
...
func BlockHeaderMaxSize() (s int) {
	...
	s += msgp.ArrayHeaderSize + ((bounds.MaxMarkAbsent) * (basics.AddressMaxSize()))
	s += 3 + basics.MicrosMaxSize() + 3 + basics.MicroAlgosMaxSize()
	return
}
