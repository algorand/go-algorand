...
func TestMarshalUnmarshalUpgradeState(t *testing.T) {
	v := UpgradeState{}
	bts, err := v.MarshalMsg(nil)
	if err != nil {
		t.Fatal(err)
...
func BenchmarkMarshalMsgUpgradeState(b *testing.B) {
	v := UpgradeState{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgUpgradeState(b *testing.B) {
	v := UpgradeState{}
	bts := make([]byte, 0, v.Msgsize())
	bts, _ = v.MarshalMsg(bts[0:0])
	b.SetBytes(int64(len(bts)))
...
func BenchmarkUnmarshalUpgradeState(b *testing.B) {
	v := UpgradeState{}
	bts, _ := v.MarshalMsg(nil)
	b.ReportAllocs()
	b.SetBytes(int64(len(bts)))
