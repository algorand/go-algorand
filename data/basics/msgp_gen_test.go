...
func TestMarshalUnmarshalpqSignatureScheme(t *testing.T) {
	partitiontest.PartitionTest(t)
	v := pqSignatureScheme{}
	bts := v.MarshalMsg(nil)
	left, err := v.UnmarshalMsg(bts)
...
func TestRandomizedEncodingpqSignatureScheme(t *testing.T) {
	protocol.RunEncodingTest(t, &pqSignatureScheme{})
}

func BenchmarkMarshalMsgpqSignatureScheme(b *testing.B) {
	v := pqSignatureScheme{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgpqSignatureScheme(b *testing.B) {
	v := pqSignatureScheme{}
	bts := make([]byte, 0, v.Msgsize())
	bts = v.MarshalMsg(bts[0:0])
	b.SetBytes(int64(len(bts)))
...
func BenchmarkUnmarshalpqSignatureScheme(b *testing.B) {
	v := pqSignatureScheme{}
	bts := v.MarshalMsg(nil)
	b.ReportAllocs()
	b.SetBytes(int64(len(bts)))
