		...
		for zb0009 > 0 {
			...
			case "appl":
				...
				if zb0034 {
					...
					(*z).AccountData.AppLocalStates = make(map[AppIndex]AppLocalState, zb0033)
				}
				for zb0033 > 0 {
					var zb0005 AppIndex
					var zb0006 AppLocalState
			...
			case "appp":
				...
				if zb0036 {
					...
					(*z).AccountData.AppParams = make(map[AppIndex]AppParams, zb0035)
				}
				for zb0035 > 0 {
					var zb0007 AppIndex
					var zb0008 AppParams
