...
func (c *Client) MakeUnsignedAppCreateTx(onComplete transactions.OnCompletion, approvalProg []byte, clearProg []byte, globalSchema basics.StateSchema, localSchema basics.StateSchema, appArgs []string, accounts []string, foreignApps []uint64) (tx transactions.Transaction, err error) {
	return c.MakeUnsignedApplicationCallTx(0, appArgs, accounts, foreignApps, onComplete, approvalProg, clearProg, globalSchema, localSchema)
}

// MakeUnsignedAppUpdateTx makes a transaction for updating an application's programs
func (c *Client) MakeUnsignedAppUpdateTx(appIdx uint64, appArgs []string, accounts []string, foreignApps []uint64, approvalProg []byte, clearProg []byte) (tx transactions.Transaction, err error) {
	return c.MakeUnsignedApplicationCallTx(appIdx, appArgs, accounts, foreignApps, transactions.UpdateApplicationOC, approvalProg, clearProg, emptySchema, emptySchema)
}

// MakeUnsignedAppDeleteTx makes a transaction for deleting an application
func (c *Client) MakeUnsignedAppDeleteTx(appIdx uint64, appArgs []string, accounts []string, foreignApps []uint64) (tx transactions.Transaction, err error) {
	return c.MakeUnsignedApplicationCallTx(appIdx, appArgs, accounts, foreignApps, transactions.DeleteApplicationOC, nil, nil, emptySchema, emptySchema)
}

// MakeUnsignedAppOptInTx makes a transaction for opting in to (allocating
// some account-specific state for) an application
func (c *Client) MakeUnsignedAppOptInTx(appIdx uint64, appArgs []string, accounts []string, foreignApps []uint64) (tx transactions.Transaction, err error) {
	return c.MakeUnsignedApplicationCallTx(appIdx, appArgs, accounts, foreignApps, transactions.OptInOC, nil, nil, emptySchema, emptySchema)
}
...
func (c *Client) MakeUnsignedAppCloseOutTx(appIdx uint64, appArgs []string, accounts []string, foreignApps []uint64) (tx transactions.Transaction, err error) {
	return c.MakeUnsignedApplicationCallTx(appIdx, appArgs, accounts, foreignApps, transactions.CloseOutOC, nil, nil, emptySchema, emptySchema)
}
...
// application's logic.
func (c *Client) MakeUnsignedAppClearStateTx(appIdx uint64, appArgs []string, accounts []string, foreignApps []uint64) (tx transactions.Transaction, err error) {
	return c.MakeUnsignedApplicationCallTx(appIdx, appArgs, accounts, foreignApps, transactions.ClearStateOC, nil, nil, emptySchema, emptySchema)
}
...
func (c *Client) MakeUnsignedAppNoOpTx(appIdx uint64, appArgs []string, accounts []string, foreignApps []uint64) (tx transactions.Transaction, err error) {
	return c.MakeUnsignedApplicationCallTx(appIdx, appArgs, accounts, foreignApps, transactions.NoOpOC, nil, nil, emptySchema, emptySchema)
}
...
func (c *Client) MakeUnsignedApplicationCallTx(appIdx uint64, appArgs []string, accounts []string, foreignApps []uint64, onCompletion transactions.OnCompletion, approvalProg []byte, clearProg []byte, globalSchema basics.StateSchema, localSchema basics.StateSchema) (tx transactions.Transaction, err error) {
