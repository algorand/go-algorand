...
type algodExpectFixture struct {
	testDir     string
	testDataDir string
	testDirTmp  bool
	t           *testing.T
...
func (f *algodExpectFixture) initialize(t *testing.T) (err error) {
	f.t = t
...
func (f *algodExpectFixture) getTestDir(testName string) (workingDir, algoDir string, err error) {
...
func (f *algodExpectFixture) removeTestDir(workingDir string) (err error) {
