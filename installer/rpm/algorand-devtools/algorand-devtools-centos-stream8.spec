...
install -m 644 ${REPO_DIR}/installer/rpm/algorand-devtools/algorand-devtools-centos-stream8.repo %{buildroot}/usr/lib/algorand/yum.repos.d/algorand-devtools-centos-stream8.repo
...
/usr/lib/algorand/yum.repos.d/algorand-devtools-centos-stream8.repo
