...
//
//go:generate go run github.com/go-swagger/go-swagger/cmd/swagger@v0.30.5 generate spec -m -o="./swagger.json"
//go:generate go run github.com/go-swagger/go-swagger/cmd/swagger@v0.30.5 validate ./swagger.json --stop-on-error
