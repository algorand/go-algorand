...
var cannedStatusReportCatchingUpGolden = node.StatusReport{
...
const (
	// CaughtUpAndReady stands for testing mock node is finishing catching up and /ready should return 200
	CaughtUpAndReady = iota
	// CatchingUp stands for mock node is mocking catching up state, and /ready should return 400
	CatchingUp
	// StoppedAtUnsupported stands for mock node stopped at unsupported round, and /ready should return 500
...
func (m *mockNode) Status() (s node.StatusReport, err error) {
	...
	case CatchingUp:
		s = cannedStatusReportCatchingUpGolden
