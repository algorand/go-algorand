...
func (m *mockedLedger) LookupAgreement(basics.Round, basics.Address) (basics.AgreementAccountData, error) {
	return basics.AgreementAccountData{}, errors.New("not needed for mockedLedger")
}
