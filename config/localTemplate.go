...
type Local struct {
	...
	TxBacklogServiceRateWindowSeconds int `version[26]:"10"`
	...
	// if Rate Limiting is enabled, the over-all TXBacklog Size will be larger by MAX_PEERS*TxBacklogReservedCapacityPerPeer
