...
type Local struct {
	...
	// EnableSimulationUnlimitedResourceAccess enables specifying the AllowUnlimitedResourceAccess
	// option during transaction simulation.
	EnableSimulationUnlimitedResourceAccess bool `version[27]:"false"`
}
