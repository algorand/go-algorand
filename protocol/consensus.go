...
// DEPRECATEDConsensusV7 increases MaxBalLookback to 320 in preparation for
// the twin seeds change.
const DEPRECATEDConsensusV7 = ConsensusVersion("v7")

// DEPRECATEDConsensusV8 uses the new parameters and seed derivation policy
// from the agreement protocol's security analysis.
const DEPRECATEDConsensusV8 = ConsensusVersion("v8")

// DEPRECATEDConsensusV9 increases min balance to 100,000 microAlgos.
const DEPRECATEDConsensusV9 = ConsensusVersion("v9")
