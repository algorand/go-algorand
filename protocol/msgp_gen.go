...
// MarshalMsg implements msgp.Marshaler
func (z NodeType) MarshalMsg(b []byte) (o []byte) {
	o = msgp.Require(b, z.Msgsize())
	o = msgp.AppendUint64(o, uint64(z))
	return
}

func (_ NodeType) CanMarshalMsg(z interface{}) bool {
	_, ok := (z).(NodeType)
	if !ok {
		_, ok = (z).(*NodeType)
	}
...
func (_ *NodeType) CanUnmarshalMsg(z interface{}) bool {
	_, ok := (z).(*NodeType)
	return ok
}
...
// MsgIsZero returns whether this is a zero value
func (z NodeType) MsgIsZero() bool {
	return z == 0
}
