...
func TestMarshalUnmarshalOneTimeSignatureSecretsHeader(t *testing.T) {
	partitiontest.PartitionTest(t)
	v := OneTimeSignatureSecretsHeader{}
	bts := v.MarshalMsg(nil)
	left, err := v.UnmarshalMsg(bts)
	if err != nil {
		t.Fatal(err)
...
func TestRandomizedEncodingOneTimeSignatureSecretsHeader(t *testing.T) {
	protocol.RunEncodingTest(t, &OneTimeSignatureSecretsHeader{})
}

func BenchmarkMarshalMsgOneTimeSignatureSecretsHeader(b *testing.B) {
	v := OneTimeSignatureSecretsHeader{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgOneTimeSignatureSecretsHeader(b *testing.B) {
	v := OneTimeSignatureSecretsHeader{}
	bts := make([]byte, 0, v.Msgsize())
	bts = v.MarshalMsg(bts[0:0])
	b.SetBytes(int64(len(bts)))
...
func BenchmarkUnmarshalOneTimeSignatureSecretsHeader(b *testing.B) {
	v := OneTimeSignatureSecretsHeader{}
	bts := v.MarshalMsg(nil)
	b.ReportAllocs()
	b.SetBytes(int64(len(bts)))
