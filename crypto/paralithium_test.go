...
func TestParalithiumWrongSeed(t *testing.T) {
	...
	var alterSeed = [cparalithium.RhoSize]byte{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00}

	sk, pk := cparalithium.NewKeysWithRho(cparalithium.ParalithiumRho(alterSeed))
