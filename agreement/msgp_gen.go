...
func (z *proposal) MarshalMsg(b []byte) (o []byte) {
	...
	if (*z).unauthenticatedProposal.Block.BlockHeader.TxnRoot.SHA512_256.MsgIsZero() {
		zb0004Len--
		zb0004Mask |= 0x20000000
	}
	if (*z).unauthenticatedProposal.Block.BlockHeader.TxnRoot.SHA256.MsgIsZero() {
		zb0004Len--
	...
	if zb0004Len != 0 {
		...
		if (zb0004Mask & 0x20000000) == 0 { // if not empty
			...
			o = (*z).unauthenticatedProposal.Block.BlockHeader.TxnRoot.SHA512_256.MarshalMsg(o)
		}
		if (zb0004Mask & 0x40000000) == 0 { // if not empty
			// string "txn256"
			o = append(o, 0xa6, 0x74, 0x78, 0x6e, 0x32, 0x35, 0x36)
			o = (*z).unauthenticatedProposal.Block.BlockHeader.TxnRoot.SHA256.MarshalMsg(o)
		}
...
func (z *proposal) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	if _, ok := err.(msgp.TypeError); ok {
		...
		if zb0004 > 0 {
			zb0004--
			bts, err = (*z).unauthenticatedProposal.Block.BlockHeader.TxnRoot.SHA256.UnmarshalMsg(bts)
			if err != nil {
		...
		if zb0004 > 0 {
			zb0004--
			bts, err = (*z).unauthenticatedProposal.Block.BlockHeader.TxnRoot.SHA512_256.UnmarshalMsg(bts)
			if err != nil {
...
func (z *unauthenticatedProposal) MarshalMsg(b []byte) (o []byte) {
	...
	if (*z).Block.BlockHeader.TxnRoot.SHA512_256.MsgIsZero() {
		zb0004Len--
		zb0004Mask |= 0x20000000
	}
	if (*z).Block.BlockHeader.TxnRoot.SHA256.MsgIsZero() {
		zb0004Len--
		zb0004Mask |= 0x40000000
	}
	...
	if zb0004Len != 0 {
		...
		if (zb0004Mask & 0x20000000) == 0 { // if not empty
			// string "txn"
			o = append(o, 0xa3, 0x74, 0x78, 0x6e)
			o = (*z).Block.BlockHeader.TxnRoot.SHA512_256.MarshalMsg(o)
		}
		if (zb0004Mask & 0x40000000) == 0 { // if not empty
			// string "txn256"
			o = append(o, 0xa6, 0x74, 0x78, 0x6e, 0x32, 0x35, 0x36)
			o = (*z).Block.BlockHeader.TxnRoot.SHA256.MarshalMsg(o)
		}
		if (zb0004Mask & 0x80000000) == 0 { // if not empty
			// string "txns"
			o = append(o, 0xa4, 0x74, 0x78, 0x6e, 0x73)
...
func (z *unauthenticatedProposal) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	if _, ok := err.(msgp.TypeError); ok {
		...
		if zb0004 > 0 {
			zb0004--
			bts, err = (*z).Block.BlockHeader.TxnRoot.SHA256.UnmarshalMsg(bts)
			if err != nil {
				err = msgp.WrapError(err, "struct-from-array", "SHA256")
				return
			}
		...
		if zb0004 > 0 {
			zb0004--
			bts, err = (*z).Block.BlockHeader.TxnRoot.SHA512_256.UnmarshalMsg(bts)
			if err != nil {
				err = msgp.WrapError(err, "struct-from-array", "SHA512_256")
				return
			}
