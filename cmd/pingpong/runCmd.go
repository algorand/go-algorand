...
func init() {
	...
	runCmd.Flags().Uint32Var(&appProgGlobKeys, "appproggk", 0, "The size of hashes to include in the Application")
	runCmd.Flags().Uint32Var(&appProgLocalKeys, "appproglk", 0, "The size of hashes to include in the Application")
