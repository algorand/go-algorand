...
func makeStatusString(stat v1.NodeStatus) string {
	...
	return fmt.Sprintf(infoNodeStatus, stat.LastRound, lastRoundTime, catchupTime, stat.LastVersion, stat.NextVersion, stat.NextVersionRound, stat.NextVersionSupported, stat.NextVersionUpgradeable, stat.HasSyncedSinceStartup)
}
