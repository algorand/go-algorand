...
const (
	...
	validRangeArgsError  = "First round valid or last round valid was supplied, but not both. Supply both or neither"
	validRangeLargeError = "Difference between first and last round valid cannot be greater than %d, but range was %d - %d = %d"
