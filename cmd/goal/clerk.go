...
func init() {
	...
	sendCmd.Flags().StringVarP(&programSource, "from-program", "F", "", "Program source to use as account logic, should point to a file")
	...
	signCmd.Flags().StringVarP(&programSource, "program", "p", "", "Program source to use as account logic, should point to a file")
