...
sg docker "docker run --rm --env-file ${HOME}/build_env_docker --mount type=bind,src=${HOME}/docker_test_resources,dst=/root/stuff --mount type=bind,src=${HOME}/go,dst=/root/go --mount type=bind,src=/usr/local/go,dst=/usr/local/go ubuntu:16.04 bash /root/go/src/github.com/algorand/go-algorand/scripts/release/helper/debian/docker_ubuntu_test.sh"

export DC_IP

sg docker "/root/go/src/github.com/algorand/go-algorand/scripts/release/helper/debian/docker_debian_test.sh ${HOME}/docker_test_resources"
