...
scp -i ReleaseBuildInstanceKey.pem -o StrictHostKeyChecking=no -r scripts/release/ci/build/stage/setup/task.sh gnupg2.2.9_centos7_amd64.tar.bz2 ubuntu@"$INSTANCE":
