...
sg docker "docker build -t algocentosbuild - < $HOME/ben-branch/scripts/release/ci/build/rpm/centos-build.Dockerfile"
...
sg docker "docker run --rm --env-file ${HOME}/build_env_docker --mount type=bind,src=${HOME},dst=/root/subhome algocentosbuild /root/subhome/ben-branch/scripts/release/ci/build/rpm/build.sh"
