...
bin_files=("algocfg" "algod" "algoh" "algokey" "carpenter" "catchupsrv" "ddconfig.sh" "diagcfg" "find-nodes.sh" "goal" "kmd" "msgpacktool" "node_exporter" "update.sh" "updater" "algotmpl" "COPYING")
...
bin_files=("algons" "auctionconsole" "auctionmaster" "auctionminion" "auctionbank" "coroner" "dispenser" "netgoal" "nodecfg" "pingpong" "cc_service" "cc_agent" "cc_client" "COPYING")
mkdir -p ${TOOLS_ROOT}
for bin in "${bin_files[@]}"; do
