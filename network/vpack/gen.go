...
func (g *codeGenerator) emitFieldConsts() string {
	...
	return enumBuf.String() + fixBuf.String() + "\n"
}
...
`
	...
	return os.WriteFile("parse_gen.go", out, 0o644)
}
...
{{- range $fd := .Fields}}
    ...
    {{- else if $fd.IsUint64Alias}}
                ...
                c.writeVaruint({{$fd.EnumConst}}, val)
